<?php
$role = isset($content['#lfz']['show_role']) ? $content['#lfz']['show_role'] : false;
$show_user_thumb = isset($content['#lfz']['show_user_thumb']) ? $content['#lfz']['show_user_thumb'] : true;
$show_comment_form = isset($content['#lfz']['show_comment_form']) ? $content['#lfz']['show_comment_form'] : true;
?>
<?php
...
<div id="comments" class="col-xs-12 <?php print $classes; ?>"<?php print $attributes; ?>>
  ...
  <?php
    ...
    if ($role && !user_has_role(array_search($role, user_roles()), $user)) {
        continue;
    }
